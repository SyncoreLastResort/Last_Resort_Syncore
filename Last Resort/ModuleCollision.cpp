...
ModuleCollision::ModuleCollision()
{
	...
	matrix[COLLIDER_WALL][COLLIDER_BALL2] = true;
	matrix[COLLIDER_WALL][COLLIDER_BOSS] = false;
	matrix[COLLIDER_WALL][COLLIDER_BOSS_SHOT] = false;
	...
	matrix[COLLIDER_PLAYER][COLLIDER_BOSS_SHOT] = true;
	...
	matrix[COLLIDER_PLAYER2][COLLIDER_BALL] = false;
	matrix[COLLIDER_PLAYER2][COLLIDER_BALL2] = false;
	matrix[COLLIDER_PLAYER2][COLLIDER_BOSS] = true;
	matrix[COLLIDER_PLAYER2][COLLIDER_PLAYER] = false;
	matrix[COLLIDER_PLAYER2][COLLIDER_BOSS_SHOT] = true;
	...
	matrix[COLLIDER_ENEMY][COLLIDER_BOSS_SHOT] = false;
	...
	matrix[COLLIDER_PLAYER_SHOT][COLLIDER_BOSS_SHOT] = false;
	...
	matrix[COLLIDER_PLAYER2_SHOT][COLLIDER_BOSS] = true;
	matrix[COLLIDER_PLAYER2_SHOT][COLLIDER_BOSS_SHOT] = false;
	...
	matrix[COLLIDER_ENEMY_SHOT][COLLIDER_BOSS_SHOT] = false;
	...
	matrix[COLLIDER_BALL][COLLIDER_PLAYER2] = false;
	...
	matrix[COLLIDER_BALL][COLLIDER_BOSS] = true;
	matrix[COLLIDER_BALL][COLLIDER_BOSS_SHOT] = false;
	...
	matrix[COLLIDER_BALL2][COLLIDER_PLAYER2] = false;
	matrix[COLLIDER_BALL2][COLLIDER_PLAYER_SHOT] = false;
	matrix[COLLIDER_BALL2][COLLIDER_PLAYER2_SHOT] = false;
	matrix[COLLIDER_BALL2][COLLIDER_ENEMY] = true;
	matrix[COLLIDER_BALL2][COLLIDER_ENEMY_SHOT] = true;
	matrix[COLLIDER_BALL2][COLLIDER_WALL] = true;
	matrix[COLLIDER_BALL2][COLLIDER_BOSS] = true;
	matrix[COLLIDER_BALL2][COLLIDER_BOSS_SHOT] = false;
	matrix[COLLIDER_BALL2][COLLIDER_POWERUP] = false;

	matrix[COLLIDER_BOSS][COLLIDER_WALL] = false;
	matrix[COLLIDER_BOSS][COLLIDER_PLAYER] = true;
	matrix[COLLIDER_BOSS][COLLIDER_PLAYER2] = true;
	...
	matrix[COLLIDER_BOSS][COLLIDER_BALL2] = true;
	matrix[COLLIDER_BOSS][COLLIDER_BOSS] = false;
	matrix[COLLIDER_BOSS][COLLIDER_BOSS_SHOT] = false;
	matrix[COLLIDER_BOSS][COLLIDER_POWERUP] = false;

	matrix[COLLIDER_BOSS_SHOT][COLLIDER_WALL] = false;
	matrix[COLLIDER_BOSS_SHOT][COLLIDER_PLAYER] = true;
	matrix[COLLIDER_BOSS_SHOT][COLLIDER_PLAYER2] = true;
	matrix[COLLIDER_BOSS_SHOT][COLLIDER_ENEMY] = false;
	matrix[COLLIDER_BOSS_SHOT][COLLIDER_PLAYER_SHOT] = false;
	matrix[COLLIDER_BOSS_SHOT][COLLIDER_PLAYER2_SHOT] = false;
	matrix[COLLIDER_BOSS_SHOT][COLLIDER_ENEMY_SHOT] = false;
	matrix[COLLIDER_BOSS_SHOT][COLLIDER_BALL] = false;
	matrix[COLLIDER_BOSS_SHOT][COLLIDER_BALL2] = false;
	matrix[COLLIDER_BOSS_SHOT][COLLIDER_BOSS] = false;
...
>>>>>>> 65fccacc02f79218802265900443484c93c19d10
	...
	matrix[COLLIDER_POWERUP][COLLIDER_BOSS_SHOT] = false;
...
void ModuleCollision::DebugDraw()
{
	...
	for(uint i = 0; i < MAX_COLLIDERS; ++i)
	{
		...
		switch(colliders[i]->type)
		{
			...
			case COLLIDER_BALL: // pink
				App->render->DrawQuad(colliders[i]->rect, 255, 0, 255, alpha);
			case COLLIDER_BOSS: // purple
				App->render->DrawQuad(colliders[i]->rect, 155, 0, 255, alpha);
			case COLLIDER_PLAYER2://weird green
				App->render->DrawQuad(colliders[i]->rect, 0, 255, 108, alpha);
			case COLLIDER_BOSS_SHOT://dark purple
				App->render->DrawQuad(colliders[i]->rect, 165, 0, 171, alpha);
			break;
		}
	}
}
