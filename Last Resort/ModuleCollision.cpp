...
ModuleCollision::ModuleCollision()
{
	...
	matrix[COLLIDER_BALL][COLLIDER_BOSS_SHOT] = true;
	...
	matrix[COLLIDER_BALL2][COLLIDER_BOSS_SHOT] = true;
	...
	matrix[COLLIDER_BOSS_SHOT][COLLIDER_BALL] = true;
	matrix[COLLIDER_BOSS_SHOT][COLLIDER_BALL2] =true;
